...
flags.DEFINE_list(
    ...
    ["/ocean/projects/cis240129p/shared/data/emg_data/silent_parallel_data"],
    "silent data locations",
)
flags.DEFINE_list(
    "voiced_data_directories",
    [
        "/ocean/projects/cis240129p/shared/data/emg_data/voiced_parallel_data",
        "/ocean/projects/cis240129p/shared/data/emg_data/nonparallel_data",
    ],
